...
mydb = msc.connect(host='localhost', user='root',
                   password='root', database='user_data')
...
class reminder_screen(Tk):
    def __init__(self):
        ...
        Button(self, text="Set", font="MicrosoftYaheiUiLight 10", foreground="white",
               bg="#404040", command=self.set_, width=10, padx=10, pady=10,cursor="hand2").place(x=150, y=350)
    ...
    def set_(self):
        ...
        if hrs == "" or title_ == "" or message_ == "" or mins == "":
            ...
            msg.showinfo("Alert!", "Reminder has been Set up")
            if r_button_val == "pm":
                hrs = hrs+12
